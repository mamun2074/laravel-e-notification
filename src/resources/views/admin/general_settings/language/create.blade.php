                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header m-b-20">
                            {{ __('root.general_settings_language.language_add_form') }}
                        </div>
                        <div class="body">
                            <form id="languageAddForm">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input autocomplete="off" value="" name="name" type="text"
                                                    class="form-control">
                                                <label
                                                    class="form-label">{{ __('root.general_settings_language.name') }}<span
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input autocomplete="off" value="" name="code" type="text"
                                                    class="form-control">
                                                <label
                                            ...
                                            <div class="form-line">
                                                <select data-live-search="true" class="form-control show-tick"
                                                    ...
                                                    @foreach ($countries as $country)
                                                        <option @if ($country->id == old('country_id')) selected @endif
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input autocomplete="off" value="" name="order" type="number"
                                                    class="form-control">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-line p-b-25">
                                            <button type="button" id="languageAddBtn"
