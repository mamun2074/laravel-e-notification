                            ...
                            <form id="userForm">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input autocomplete="off" value="" name="email" type="text"
                                                    class="form-control">
                                        ...
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <select data-live-search="true" class="form-control show-tick"
                                                    name="user_type">
                                                    <option value="">{{ __('root.user.select_user_type') }}</option>
                                                    @foreach ($user_types as $key => $user_type)
                                                        @if ($user_type==1)
                                                            @continue
                                                        @endif
                                                        <option @if ($user_type == old('user_type')) selected @endif
                                                            value="{{ $user_type }}">
...
@push('include-js')
    ...
    <script src="{{ Helper::assetV('admin/asset/js/admin/user/create.js') }}"></script>
@endpush
